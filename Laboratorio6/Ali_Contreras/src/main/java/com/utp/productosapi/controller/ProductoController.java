...
/**
 * El Controller de la semana 5 se mantiene casi igual: depende de ProductoService
 * y no sabe si los datos viven en memoria o en MySQL. Eso demuestra el desacoplamiento
 * entre la capa web y la capa de persistencia.
 */
@RestController
